<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                    v-hasPermission="['monitor:operationLog:remove']"
                    :disabled="multiple"
                    icon="Delete"
                    plain
                    type="danger"
            ...
            <el-col :span="1.5">
                <el-button
                    v-hasPermission="['monitor:operationLog:export']"
                    icon="Download"
                    plain
                    type="warning"
                    @click="handleExport"
        ...
        >
            ...
            <el-table-column align="center" label="日志编号" prop="operationId" />
            <el-table-column
            ...
            <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
                <template #default="scope">
                    <el-button
                        v-hasPermission="['monitor:operationLog:query']"
                        icon="View"
                        link
                        type="primary"
                ...
                <el-row>
                    <el-col :span="12">
                        ...
                        <el-form-item label="登录信息："
                            >{{ form.operationName }} / {{ form.operationIp }} / {{ form.operationLocation }}
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
